...
namespace Pwa.Infrastructure.EfCore.Expressions
{
    public static class DeveloperExpression
    {
        ...
        public static Expression<Func<DeveloperDto, Developer>> FromDto => _ => new Developer(_.Email, _.UserName, _.FullName, _.NationalCode, _.PhoneNumber, _.AddressId, _.StatisticId)
        {
            Id = _.Id,
        };
    }
